...
class Window(QWidget, Ui_Window):
    ...
    def _updateStateWhenNoFiles(self):
        ...
        self.loadFileButton.setFocus(True)
        self.renameFileButton.setEnabled(False)
        self.prefixEdit.clear()
        self.prefixEdit.setEnabled(False)

    def _connectSignalsSlots(self):
        self.loadFileButton.clicked.connect(self.loadFiles)
        self.renameFileButton.clicked.connect(self.renameFiles)
    ...
    def _runRenamerThread(self):
        ...
        self._renamer.progressed.connect(self._updateProgessBar)
    ...
    def _updateProgessBar(self, fileNumber):
